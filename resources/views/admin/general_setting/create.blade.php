...
@section('content')
    ...
    <div class="container-xxl">
        ...
        <x-breadcrumb listRoute="{{route('admin.general-settings.index')}}" model="GeneralSetting" item="Create"></x-breadcrumb>

        <div class="card">
            <div class="card-body">

                <x-form.wrapper action="{{route('admin.general-settings.store')}}" method="POST" enctype="multipart/form-data">
...
@push('custom_js')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\GeneralSettingRequest') !!}
