...
<x-form.row>
                ...
                <x-form.input type="text" col="6" :req="true" label="Name" id="name" name="name" value="{{$testimonial->name}}" />
</x-form.row>
                <x-form.preview id="featured-thumb" . url="{{$testimonial->image_path}}" />
               
                <x-form.input type="text" label="Slug" col="6" :req="true" id="slug" name="slug" value="{{$testimonial->slug}}" />
