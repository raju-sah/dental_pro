...
<div class="container-xxl">
    ...
    <x-breadcrumb listRoute="{{route('admin.teams.index')}}" model="Teams" item="Create"></x-breadcrumb>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <x-form.row>
                <x-form.input type="text" col="6" label="Name" id="name" name="name" value="{{ old('name') }}" />
                <x-form.input type="text" col="6" label="Slug" id="slug" name="slug" value="{{ old('slug') }}" />
            </x-form.row>
            <x-form.row>
                <x-form.input type="text" col="6" label="Department" id="department" name="department" value="{{ old('department') }}" />
